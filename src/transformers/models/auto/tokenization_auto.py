...
if TYPE_CHECKING:
    ...
    TOKENIZER_MAPPING_NAMES = OrderedDict(
        [
            ...
            ("omegairis", ("LlamaTokenizer", "LlamaTokenizerFast" if is_tokenizers_available() else None)),
            ...
            ("omegasparkvision", ("LlamaTokenizer", "LlamaTokenizerFast" if is_tokenizers_available() else None)),
