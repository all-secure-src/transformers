...
class OmegaIrisForConditionalGeneration(metaclass=DummyObject):
    _backends = ["torch"]
...
class OmegaIrisModel(metaclass=DummyObject):
    _backends = ["torch"]
...
class OmegaIrisPreTrainedModel(metaclass=DummyObject):
    _backends = ["torch"]
...
class OmegaIrisProcessor(metaclass=DummyObject):
    _backends = ["torch"]
...
class OmegaSparkVisionForConditionalGeneration(metaclass=DummyObject):
    _backends = ["torch"]
...
class OmegaSparkVisionPreTrainedModel(metaclass=DummyObject):
    _backends = ["torch"]
